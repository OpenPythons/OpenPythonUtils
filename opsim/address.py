...
class MemoryMap(Enum):
    FLASH = MemoryRegion(0x08000000, 0x10000000, UC_PROT_READ | UC_PROT_EXEC)
    SRAM = MemoryRegion(0x20000000, 0x4000000, UC_PROT_READ | UC_PROT_WRITE)
    RAM = MemoryRegion(0x60000000, 0x8000000, UC_PROT_READ | UC_PROT_WRITE)
...
class PeripheralAddress(IntEnum):
    ...
    OPENPIE_CONTROLLER_PENDING = 0x40000100
    OPENPIE_CONTROLLER_EXCEPTION = 0x40000104
    OPENPIE_CONTROLLER_INTR_CHAR = 0x40000108
    OPENPIE_CONTROLLER_RAM_SIZE = 0x4000010c
    OPENPIE_CONTROLLER_IDLE = 0x40000110
    OPENPIE_CONTROLLER_INSNS = 0x40000114
